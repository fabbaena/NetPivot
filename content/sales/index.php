...
if($usuario == false  || !isset($roles[2])) { 
    header('location: /'); 
    exit();
}
?>
    ...
    <div class="col-md-10 content">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4>Sales Configuration Analyzer</h4>
            </div>
            <div class="panel-body">
                <form enctype="multipart/form-data" action='../engine/uploader.php?id='<?php $id;?> method="POST">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-3">
                                <input type="submit" value="Analyze" class="btn btn-default btn-lg" >                            
                            </div>  
                        </div>    
                        <?php 
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h4>Anaysis Manager</h4></div>
            <div class="panel-body">
                <form method="POST">   
                        ...
                        try {
                            ...
                            if (empty($files)== false AND empty($dones)== false ) { //   
                                echo '  <div class="col-md-12">
                                        <input type="submit" class="btn btn-primary btn-lg margin-set pull-right" value="View Analysis" title="View Analysis" formaction="brief.php">                                                                                  
