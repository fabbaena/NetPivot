...
ALTER SEQUENCE IF EXISTS users_id_seq INCREMENT BY 1 MINVALUE 10 MAXVALUE 32767 START WITH 10 RESTART 10 CYCLE OWNED BY users.id;
...
ALTER SEQUENCE IF EXISTS roles_id_seq INCREMENT BY 1 MINVALUE 10 MAXVALUE 32767 START WITH 10 RESTART 10 CYCLE OWNED BY roles.id;
