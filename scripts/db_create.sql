...
DROP TABLE IF EXISTS NetPivot.modules CASCADE;
...
DROP TABLE IF EXISTS NetPivot.obj_grps CASCADE;
...
DROP TABLE IF EXISTS NetPivot.obj_names CASCADE;
...
DROP TABLE IF EXISTS NetPivot.attributes CASCADE;
...
DROP VIEW IF EXISTS NetPivot.obj_names_view CASCADE;
...
DROP VIEW IF EXISTS NetPivot.obj_grps_view CASCADE;
...
DROP VIEW IF EXISTS NetPivot.modules_view CASCADE;
...
-- TRIGGER NetPivot.details
DROP TRIGGER IF EXISTS NetPivot.new_detail_record;
DELIMITER $$
